...
def mutation_classification(input_file, output_dir, sample_name, model_dir="./", model_name="P6_rep2", random_seed=100, \
                            ...
                            thr_popAF=1e-4, subset=None, drop_subset=None, hard_filter=True, \
                            ...
                            save_pca=True, save_shap=False, use_lr=False, not_pred_het=False, transform_old_name=False, \
    ...
    Inputs:
        ...
        not_pred_het - Boolean variable of whether not predicting the heterozygous sites using logistic regression model (default=False)
    ...
    not_related_columns = ['gene_type', 'gene_strand', 'major_read_strand', 'GCcontent', \
                            ...
                            'af', 'alpha', 'beta', 'rweigh', 'true_similarity', \
                            'refine_hFDR99', 'refine_hFDR49', 'refine_hFDR29', 'refine_hFDR9', 'refine_hFDR1', \
                            'hFDR', 'cosine_sim1', 'cosine_sim2', 'false_similarity1', 'false_similarity2', \
